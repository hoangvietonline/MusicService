...
import hoangviet.ndhv.demoui.ui.main.MusicAdapter.OnClickItemMusicListener
import hoangviet.ndhv.demoui.ui.playmusic.PlayMusicActivity
import java.util.*

class MainActivity : AppCompatActivity(), OnClickItemMusicListener {
    private var musicList: MutableList<Music>? = null
    private var adapter: MusicAdapter? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mp3)
        val recyclerView = findViewById<RecyclerView>(R.id.rcViewMusic)
        musicList = ArrayList()
