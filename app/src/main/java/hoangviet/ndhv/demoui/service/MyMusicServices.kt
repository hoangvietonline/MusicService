...
class MyMusicServices : Service(), MediaPlayer.OnErrorListener {
    ...
    private fun sendPosition() {
        ...
        intentPosition.action = PlayMusicActivity.MediaPlayerBroadcast.SEND_POSITION_MUSIC_PLAY
    ...
    fun mediaPlayerCurrentTime() {
        ...
        handler.postDelayed(object : Runnable {
            override fun run() {
                ...
                intentCurrent.action = PlayMusicActivity.MediaPlayerBroadcast.SEND_TIME_MEDIA_PLAYER
                ...
                mMediaPlayer!!.setOnCompletionListener {
                    ...
                    if (repeatOne == "OKE") {
                        ...
                        intentPositionPlayMusic.action = PlayMusicActivity.MediaPlayerBroadcast.SEND_MUSIC_PLAY_AGAIN
